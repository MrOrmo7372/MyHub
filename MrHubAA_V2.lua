...
--#################################################################################################################################################################################################################################################################
--CREATE CONFIG VALUE IN GAME
--#################################################################################################################################################################################################################################################################
function Create_Bool_Value(name)
...
local Auto_Start_Player_BOOLEAN = Create_Bool_Value("Auto_Start_Player_BOOLEAN")
local Auto_Retry_Player_BOOLEAN = Create_Bool_Value("Auto_Retry_Player_BOOLEAN")
--#################################################################################################################################################################################################################################################################
...
function Auto_Start_Fucntion()
	if Auto_Start_Player_BOOLEAN.Value == false then
		local Auto_Start_Call = Vote_Start:InvokeServer()
		Auto_Start_Player_BOOLEAN.Value = true
	end
end
...
local Auto_Retry_Toggle = AutoFarm:CreateToggle({
	...
	--The variable (Value) is a boolean on whether the toggle is true or false
		...
		if Auto_Retry_Boolean == true --[[OTHER/]] and Auto_Retry_Player_BOOLEAN.Value == false and ResultsUI.Enabled == true then
			Auto_Retry_Function()
		end
	end,
})
